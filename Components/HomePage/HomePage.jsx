    ...
    return(
        <div className="lg:space-x-20 h-screen w-full flex flex-col md:flex-row
         items-center justify-center overflow-hidden" id="Home">
            ...
            <p className="hidden">Tristan Carter is an aspiring software engineer currently living in the UK. To find out more go to either his wesbsite, Github profile or LinkedIn</p>
