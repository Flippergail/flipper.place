...
export default function HomePage() {
    return(
        <div className="relative h-screen w-full flex flex-col md:flex-row align-middle overflow-hidden" id="Home">
            ...
            <p className=" hidden md:block lg:hidden ml-12 mt-20 text-text text-4xl leading-tight font-semibold">Hello, my name is Tristan.<br/>I am a Full Stack Developer living in<br/>the UK.</p>
